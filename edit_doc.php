<form class="row g-3 " action="" method="post">
    <div class="row">
        <div class="col-8 p-1 pb-3" style="background-color: #ECDBBA;">
            <div class="col-12 fs-4 text-center text-white" style="background-color:#C84C32;">แก้ไข/จัดการเอกสาร</div>
            <div class="row">
                ...
                <div class="col-6 md-2">
                    ...
                    <input type="text" name="id" id="id" class="form-control" style="pointer-events: none;opacity: 0.7;">
                </div>
                <div class="col-6 md-2">
                    <label for="no" class="col-form-label">เลขที่หนังสือ</label>
                    <input type="text" name="no" id="no" class="form-control" style="pointer-events: none;opacity: 0.7;">
                </div>
        ...
        <div class="col-4 p-1 pb-3" style="background-color: #ECDBBA;">
            <div class="col-12 fs-4 text-center text-white " style=" background-color:#C84C32;">ไฟล์</div>
            ...
            <iframe src="doc/Final_CAD.pdf" frameborder="0" class="mx-auto d-inline mt-3" width="100%" height="63%"></iframe>
            <!-- <div class="col-12">
