...
INSERT INTO `document` (`doc_id`, `doc_type_id`, `user_id`, `doc_book_number`, `doc_date`, `doc_time`, `doc_from`, `doc_topic`, `doc_refer_to`, `doc_attach`, `doc_handle`, `doc_action`, `doc_urgency`, `doc_status`) VALUES
(5, 1, 5, 'กยศ 102', '2022-05-29', '14:17', 'ที่บ้านน', 'ล้างจานoo', 'คนที่บ้าน', 'น้ำยาล้างจาน', 'ทำความสะอาด', 'ล้างจาน', 'urgen_ASAP', '1'),
(6, 2, 0, '', '', '', '', '', '', '', '', '', 'urgen_normal', '1'),
(7, 1, 0, 'กยศ 1', '2022-05-03', '15:50', 'ิวิทยาลัย', 'aaa', 'aaa', 'aa', 'aaa', 'saas', 'urgen_ASAP', '1'),
(8, 1, 6, 'กยศ 1', '2022-05-03', '15:50', 'aa', 'aaa', 'aaa', 'aa', 'aaa', 'saas', 'urgen_normal', '1');
...
--
ALTER TABLE `doc_user_file`
  MODIFY `doc_user_file_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
